					...
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							Words form the thread on which we string our happy experiences
                                  Define <strong> FZ STORE</strong>, In which we recreate life strings to weave
                                        Your own path.
						</p>
						...
						<p class="stext-113 cl6 p-b-26">
							Any questions? Let us know in store at 74/1, Maman Chowki, Bsr - 203001 or call us on (+91) 9560315195
						</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="order-md-2 col-md-7 col-lg-8 p-b-30">
					<div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							FZ STORE has started with an aim of empowering artisans by creating Direct employments and helping to sustain ancient tradition and environment of India.
