...
<!-- Search product -->
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">
								Mohd Faiz, H.No.-74/1, Maman Chowki, Bulandshahr - 203001. 
							</p>
						</div>
					</div>
	...
	<!-- Map -->
	<div class="map">
			<iframe src="https://www.google.com/maps/embed/v1/place?q=bulandshahr&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
	</div>
