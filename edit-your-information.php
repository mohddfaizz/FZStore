	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			...
			<div class="p-t-40">
				...
				FZ STORE &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved.<br>FZ STORE &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved.<br>
				<br>
